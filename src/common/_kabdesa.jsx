...
import {KABUPATEN} from '../dataCounter/dataDesa'
import _DaBuffer from './_kab_da';
class KabupatenDesa extends React.Component {
    constructor(props) {
        super(props);
            ...
            <div>
                {
                    ...
                    KABUPATEN.features.map((datas, index) => {
                        let show = true;
                        let currName = datas.properties["name_2"];
                        ...
                        return (
                            <div key={index}>
                                <GeoJSON
                                   ...
                                   {/* <div  key={datas.properties["name_2"]}> */}
