...
class _PL2016 extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            PL2016: [],
    ...
    componentDidMount() {
        Axios
            .get('http://forclime.agrisoft-cb.com:5002/data/pl_2016')
            .then(response => {
                this.setState(
                    { PL2016: response.data.features }
                );
    ...
    render() {
        let PL2016obj = this.state.PL2016
        const PLStyle = (PL2016obj) => {

            switch (PL2016obj.properties.kode_lc) {
                                    ...
                                    <Popup >
                                        <table className='table table-hover'> 
                                            <tr> 
                                                ...
                                                <td>{datas.properties.lc_2016} </td > 
                                            </tr>
                                        </table>
                                    </Popup>
