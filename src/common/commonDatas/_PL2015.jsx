...
class _PL2015 extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            PL2015: [],
    ...
    componentDidMount() {
        Axios
            .get('http://forclime.agrisoft-cb.com:5002/data/pl_2015')
            .then(response => {
                this.setState(
                    { PL2015: response.data.features }
                );
    ...
    render() {
        let PL2015obj = this.state.PL2015
        const PLStyle = (PL2015obj) => {

            switch (PL2015obj.properties.kode_lc) {
                                    ...
                                    <Popup >
                                        <table className='table table-hover'> 
                                            <tr> 
                                                ...
                                                <td>{datas.properties.lc_2015} </td > 
                                            </tr>
                                        </table>
                                    </Popup>
