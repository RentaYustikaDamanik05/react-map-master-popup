...
class _PL2017 extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            PL2017: [],
    ...
    componentDidMount() {
        Axios
            .get('http://forclime.agrisoft-cb.com:5002/data/pl_2017')
            .then(response => {
                this.setState(
                    { PL2017: response.data.features }
                );
    ...
    render() {
        let PL2017obj = this.state.PL2017
        const PLStyle = (PL2017obj) => {

            switch (PL2017obj.properties.kode_lc) {
                                    ...
                                    <Popup >
                                        <table className='table table-hover'> 
                                            <tr> 
                                                ...
                                                <td>{datas.properties.lc_2017} </td > 
                                            </tr>
                                        </table>
                                    </Popup>
