...
class _PL2012 extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            PL2012: [],
    ...
    componentDidMount() {
        Axios
            .get('http://forclime.agrisoft-cb.com:5002/data/pl_2012')
            .then(response => {
                this.setState(
                    { PL2012: response.data.features }
                );
    ...
    render() {
        let PL2012obj = this.state.PL2012
        const PLStyle = (PL2012obj) => {

            switch (PL2012obj.properties.kode_lc) {
                                    ...
                                    <Popup >
                                        <table className='table table-hover'> 
                                            <tr> 
                                                ...
                                                <td>{datas.properties.lc_2012} </td > 
                                            </tr>
                                        </table>
                                    </Popup>
