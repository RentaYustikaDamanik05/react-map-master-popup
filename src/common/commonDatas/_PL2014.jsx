...
class _PL2014 extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            PL2014: [],
    ...
    componentDidMount() {
        Axios
            .get('http://forclime.agrisoft-cb.com:5002/data/pl_2014')
            .then(response => {
                this.setState(
                    { PL2014: response.data.features }
                );
    ...
    render() {
        let PL2014obj = this.state.PL2014
        const PLStyle = (PL2014obj) => {

            switch (PL2014obj.properties.kode_lc) {
                                    ...
                                    <Popup >
                                        <table className='table table-hover'> 
                                            <tr> 
                                                ...
                                                <td>{datas.properties.lc_2014} </td > 
                                            </tr>
                                        </table>
                                    </Popup>
