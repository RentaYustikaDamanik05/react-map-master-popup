...
class _PL2013 extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            PL2013: [],
    ...
    componentDidMount() {
        Axios
            .get('http://forclime.agrisoft-cb.com:5002/data/pl_2013')
            .then(response => {
                this.setState(
                    { PL2013: response.data.features }
                );
    ...
    render() {
        let PL2013obj = this.state.PL2013
        const PLStyle = (PL2013obj) => {

            switch (PL2013obj.properties.kode_lc) {
                                    ...
                                    <Popup >
                                        <table className='table table-hover'> 
                                            <tr> 
                                                ...
                                                <td>{datas.properties.lc_2013} </td > 
                                            </tr>
                                        </table>
                                    </Popup>
