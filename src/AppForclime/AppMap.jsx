...
import _PL2018 from '../common/commonDatas/_PL2018'
import _PERSOS from '../common/commonDatas/_perSos'
import _PERSEMAIAN from '../common/commonDatas/_perSemaian'
import _PENANAMAN from '../common/commonDatas/_peNanaman'
      ...
      <div>
        <Map zoomControl={false} className="map" center={position}
          ...
          <FeatureGroup>
            ...
            {this.state.PL2018 ? <_PL2018 /> : null}
            {this.state.Per ? <_PERSEMAIAN /> : null}
            {this.state.Pen ? <_PENANAMAN/> : null}
            {this.state.Pem ? <_PEMELIHARAAN/> : null}
            {this.state.Persos ? <_PERSOS/> : null }
            {this.state.WP ? <_PW/> : null }
            {this.state.JP ? <_PJ/> : null }
            <KabupatenDesa />
            <_DaBuffer />
            <_Da_Kab />
        ...
        >
                ...
                <ExpansionPanelDetails>
                  <FormControl component="fieldset">
                    ...
                    <FormGroup>
                      ...
                      />
                       <FormControlLabel
                        control={<Switch checked={this.state.PL2018} onChange={this.switchChange('PL2018')} value="PL2018" />}
                        label="Penutupan Lahan 2018"
          ...
          <Tab disabled id="add" header="Tambah Data" icon={< FiFilePlus />}>
